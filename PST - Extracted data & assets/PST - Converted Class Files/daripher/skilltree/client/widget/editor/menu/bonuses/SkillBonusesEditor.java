...
import daripher.skilltree.client.widget.editor.menu.bonuses.SkillBonusEditor;
...
public class SkillBonusesEditor
extends EditorMenu {
    ...
    public void init() {
        ...
        this.editor.addSelectionMenu(110, -29, 90, defaultBonus).setResponder(skillBonus -> this.addSkillBonus(this.editor, (SkillBonus<?>)skillBonus)).m_93666_((Component)Component.m_237113_((String)"Add"));
