...
implements JsonSerializer<SkillBonus<?>>,
JsonDeserializer<SkillBonus<?>> {
    ...
    public JsonElement serialize(SkillBonus<?> src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        ResourceLocation serializerId = PSTRegistries.SKILL_BONUSES.get().getKey((Object)src.getSerializer());
