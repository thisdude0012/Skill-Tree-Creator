...
public class DamageTakenEventListener
implements SkillEventListener {
    ...
    public MutableComponent getTooltip(Component bonusTooltip) {
        MutableComponent damageDescription = this.damageCondition.getTooltip();
        MutableComponent eventTooltip = Component.m_237110_((String)this.getDescriptionId(), (Object[])new Object[]{bonusTooltip, damageDescription});
    ...
    public SkillEventListener.Serializer getSerializer() {
        return (SkillEventListener.Serializer)PSTEventListeners.DAMAGE_TAKEN.get();
    }
    ...
    implements SkillEventListener.Serializer {
        ...
        public void serialize(JsonObject json, SkillEventListener listener) {
            if (!(listener instanceof DamageTakenEventListener)) {
                throw new IllegalArgumentException();
            }
            DamageTakenEventListener aListener = (DamageTakenEventListener)listener;
