...
public class SkillRemovedEventListener
implements SkillEventListener {
    ...
    implements SkillEventListener.Serializer {
        ...
        public void serialize(JsonObject json, SkillEventListener listener) {
            if (!(listener instanceof SkillRemovedEventListener)) {
                throw new IllegalArgumentException();
            }
            SkillRemovedEventListener aListener = (SkillRemovedEventListener)listener;
