...
public final class AllArmorCondition
implements LivingCondition {
    ...
    public boolean isConditionMet(LivingEntity living) {
        return PlayerHelper.getArmor(living).allMatch(this.itemCondition::met);
    }
    ...
    public LivingCondition.Serializer getSerializer() {
        return (LivingCondition.Serializer)PSTLivingConditions.ALL_ARMOR.get();
    }
    ...
    implements LivingCondition.Serializer {
        ...
        public void serialize(JsonObject json, LivingCondition condition) {
            if (!(condition instanceof AllArmorCondition)) {
                throw new IllegalArgumentException();
            }
            AllArmorCondition aCondition = (AllArmorCondition)condition;
