...
public class EnchantmentAmountProvider
implements NumericValueProvider<EnchantmentAmountProvider> {
    @Nonnull
    ...
    public MutableComponent getMultiplierTooltip(SkillBonus.Target target, float divisor, Component bonusTooltip) {
        ...
        Component itemDescription = this.itemCondition.getTooltip("prepositional");
        if (divisor != 1.0f) {
    ...
    public MutableComponent getConditionTooltip(SkillBonus.Target target, NumericValueCondition.Logic logic, Component bonusTooltip, float requiredValue) {
        ...
        MutableComponent enchantmentsDescription = Component.m_237115_((String)enchantmentsKey);
        ...
        return Component.m_237110_((String)key, (Object[])new Object[]{bonusTooltip, logicDescription, enchantmentsDescription, itemDescription});
    }
    ...
    public MutableComponent getRequirementTooltip(NumericValueCondition.Logic logic, float requiredValue) {
        ...
        String valueDescription = this.formatNumber(requiredValue);
        Component logicDescription = logic.getTooltip("enchantment_amount", valueDescription);
        return Component.m_237110_((String)key, (Object[])new Object[]{logicDescription, enchantmentsDescription, itemDescription});
    }

    @Override
    public NumericValueProvider.Serializer getSerializer() {
        return (NumericValueProvider.Serializer)PSTNumericValueProviders.ENCHANTMENT_AMOUNT.get();
    }
    ...
    implements NumericValueProvider.Serializer {
        ...
        public void serialize(JsonObject json, NumericValueProvider<?> provider) {
            if (!(provider instanceof EnchantmentAmountProvider)) {
                throw new IllegalArgumentException();
            }
            EnchantmentAmountProvider aProvider = (EnchantmentAmountProvider)provider;
