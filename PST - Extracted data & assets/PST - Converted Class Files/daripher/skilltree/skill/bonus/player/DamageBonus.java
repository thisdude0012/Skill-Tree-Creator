...
public final class DamageBonus
implements SkillBonus<DamageBonus> {
    ...
    public boolean canMerge(SkillBonus<?> other) {
        if (!(other instanceof DamageBonus)) {
            return false;
        }
        DamageBonus otherBonus = (DamageBonus)other;
    ...
    public MutableComponent getTooltip() {
        MutableComponent tooltip = TooltipHelper.getSkillBonusTooltip((Component)this.damageCondition.getTooltip(), (double)this.amount, this.operation);
    ...
    private void selectTargetCondition(SkillTreeEditor editor, Consumer<DamageBonus> consumer, LivingCondition condition) {
    ...
    private void selectPlayerCondition(SkillTreeEditor editor, Consumer<DamageBonus> consumer, LivingCondition condition) {
    ...
    implements SkillBonus.Serializer {
        ...
        public void serialize(JsonObject json, SkillBonus<?> bonus) {
            ...
            DamageBonus aBonus = (DamageBonus)bonus;
