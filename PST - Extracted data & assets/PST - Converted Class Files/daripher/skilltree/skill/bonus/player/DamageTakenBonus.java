...
public final class DamageTakenBonus
implements SkillBonus<DamageTakenBonus> {
    ...
    public float getDamageBonus(AttributeModifier.Operation operation, DamageSource source, Player player, LivingEntity attacker) {
        ...
        return this.amount * this.playerMultiplier.getValue((LivingEntity)player) * this.attackerMultiplier.getValue(attacker);
    }

    @Override
    public SkillBonus.Serializer getSerializer() {
        return (SkillBonus.Serializer)PSTSkillBonuses.DAMAGE_TAKEN.get();
    }

    public DamageTakenBonus copy() {
        DamageTakenBonus bonus = new DamageTakenBonus(this.amount, this.operation);
    ...
    public boolean canMerge(SkillBonus<?> other) {
        if (!(other instanceof DamageTakenBonus)) {
            return false;
        }
        DamageTakenBonus otherBonus = (DamageTakenBonus)other;
    ...
    public MutableComponent getTooltip() {
        ...
        tooltip = TooltipHelper.getSkillBonusTooltip((Component)tooltip, (double)this.amount, this.operation);
    ...
    public void addEditorWidgets(SkillTreeEditor editor, int row, Consumer<DamageTakenBonus> consumer) {
        ...
        editor.addOperationSelection(55, 0, 145, this.operation).setResponder(operation -> this.selectOperation(consumer, (AttributeModifier.Operation)operation));
        editor.increaseHeight(19);
    ...
    private void selectTargetCondition(SkillTreeEditor editor, Consumer<DamageTakenBonus> consumer, LivingCondition condition) {
    ...
    private void selectPlayerCondition(SkillTreeEditor editor, Consumer<DamageTakenBonus> consumer, LivingCondition condition) {
    ...
    implements SkillBonus.Serializer {
        ...
        public void serialize(JsonObject json, SkillBonus<?> bonus) {
            if (!(bonus instanceof DamageTakenBonus)) {
                throw new IllegalArgumentException();
            }
            DamageTakenBonus aBonus = (DamageTakenBonus)bonus;
        ...
        public DamageTakenBonus deserialize(FriendlyByteBuf buf) {
            ...
            AttributeModifier.Operation operation = AttributeModifier.Operation.m_22236_((int)buf.readInt());
            DamageTakenBonus bonus = new DamageTakenBonus(amount, operation);
        ...
        public void serialize(FriendlyByteBuf buf, SkillBonus<?> bonus) {
            ...
            buf.writeInt(aBonus.operation.m_22235_());
