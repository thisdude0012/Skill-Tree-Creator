...
public final class ItemUsageSpeedBonus
implements SkillBonus<ItemUsageSpeedBonus> {
    ...
    public boolean canMerge(SkillBonus<?> other) {
        if (!(other instanceof ItemUsageSpeedBonus)) {
            return false;
        }
        ItemUsageSpeedBonus otherBonus = (ItemUsageSpeedBonus)other;
    ...
    public MutableComponent getTooltip() {
        ...
        MutableComponent tooltip = Component.m_237110_((String)descriptionKey, (Object[])new Object[]{itemConditionTooltip, multiplierString});
    ...
    implements SkillBonus.Serializer {
        ...
        public void serialize(JsonObject json, SkillBonus<?> bonus) {
            if (!(bonus instanceof ItemUsageSpeedBonus)) {
                throw new IllegalArgumentException();
            }
            ItemUsageSpeedBonus aBonus = (ItemUsageSpeedBonus)bonus;
